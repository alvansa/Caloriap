        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(0 * fem, 0 * fem, 30 * fem, 216 * fem),
            ...
            Container(
              // fechaVKD (27:472)
              margin:
                  EdgeInsets.fromLTRB(95 * fem, 0 * fem, 95 * fem, 120 * fem),
              width: double.infinity,
              height: 50 * fem,
              decoration: BoxDecoration(
              ...
              child: Container(
                ...
                padding: EdgeInsets.fromLTRB(
                    19.75 * fem, 15 * fem, 19.75 * fem, 18 * fem),
                width: double.infinity,
            ...
            Container(
              // ctabuttonD8j (27:481)
              margin:
                  EdgeInsets.fromLTRB(101 * fem, 0 * fem, 95 * fem, 0 * fem),
              child: TextButton(
                onPressed: () {
